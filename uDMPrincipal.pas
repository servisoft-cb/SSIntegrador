...
begin
  ...
  Consulta.SQL.Add(', PERC_IPI, PRECO_CUSTO, MATERIAL_OUTROS, ');
  Consulta.SQL.Add('DTCAD, HRCAD, DT_ALTPRECO, USA_PERC_IMP_INTERESTADUAL, SPED_TIPO_ITEM, USA_CLIQ, ');
  Consulta.SQL.Add('USUARIO, BAIXA_ESTOQUE_MAT, REF2, REFERENCIA_PADRAO, ');
  Consulta.SQL.Add('GERAR_FCI, GERAR_WEB, VALIDADE, VLR_ICMS, TAMANHO ');
